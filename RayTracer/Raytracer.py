...
earth = Material(texture = Texture("./Raytracer/earthDay.bmp"))
marble = Material(diffuse = (0.8,0.8,0.8), texture = Texture("./Raytracer/marble.bmp"), spec = 32, matType= REFLECTIVE)

canica = Material(diffuse = (0.8,0.8,1.0), texture = Texture("./Raytracer/whiteMarble.bmp"), spec = 32, ior = 1.5, matType= TRANSPARENT)
